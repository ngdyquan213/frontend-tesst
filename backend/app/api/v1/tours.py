...
def list_tours(
    ...
    duration: str | None = Query(default=None, pattern="^(short|medium|long)$"),
    group_size: str | None = Query(default=None, pattern="^(intimate|shared|large)$"),
    price_range: str | None = Query(default=None, pattern="^(under-1500|1500-2500|2500-plus)$"),
